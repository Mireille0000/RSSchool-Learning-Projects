export default class CarComponent {
  ...
  constructor() {
    ...
    this.carBody.setAttributeNS(
      null,
      "d",
      `M3565 5336 c-106 -30 -101 -26 -108 -111 -4 -42 -9 -80 -12 -85 -6
    ...
    this.wheel1 = document.createElementNS(
      "http://www.w3.org/2000/svg",
      "path",
    );
    this.wheel1.setAttributeNS(
      null,
      "d",
      `M2633 3125 c-223 -40 -410 -141 -568 -306 -132 -138 -213 -283 -262
    ...
    this.wheel2 = document.createElementNS(
      "http://www.w3.org/2000/svg",
      "path",
    );
    this.wheel2.setAttributeNS(
      null,
      "d",
      `M10700 3119 c-390 -84 -696 -376 -797 -759 -31 -117 -41 -292 -24
